...
ALEXA_URI = "https://api.eu.amazonalexa.com/v3/events" # update to appropriate URI for your region
...
# LWA constants
CODE = "RHBNiiCwVhZMwLZkxKEz" # auth code from AcceptGrant directive, update whenever you disable/enable the skill
#CLIENT_ID = "amzn1.application-oa2-client.c02fcedf20cd4efc8e8459cc80468e9d" # copy from Developer Console
#CLIENT_SECRET = "b3c51329f0e1d0cdcbd0f4ace87011e123eaef2dd1b367392b43bccff7fe1f3b" # copy from Developer Console
CLIENT_ID = "amzn1.application-oa2-client.c40b43d1dcfe4fda8c38a30be64ba821" # copy from Developer Console
CLIENT_SECRET = "bf7e63fe5c86b387868d8563d9cf6bf1a1187b11f50d1f996314a0002fb37975" # copy from Developer Console
